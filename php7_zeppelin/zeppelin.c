...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("zeppelin.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_zeppelin_globals, zeppelin_globals)
    STD_PHP_INI_ENTRY("zeppelin.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_zeppelin_globals, zeppelin_globals)
PHP_INI_END()
*/
/* }}} */
...
/* {{{ php_zeppelin_init_globals
 */
/* Uncomment this function if you have INI entries
static void php_zeppelin_init_globals(zend_zeppelin_globals *zeppelin_globals)
{
	zeppelin_globals->global_value = 0;
	zeppelin_globals->global_string = NULL;
}
*/
/* }}} */
